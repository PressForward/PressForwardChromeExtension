...
window.pfSiteData.site_url = window.localStorage.getItem('site_url'); // "https://local.wordpress.test";
window.pfSiteData.plugin_url = window.localStorage.getItem('plugin_url'); // "https://local.wordpress.test/wp-content/plugins/pressforward/";
window.pfSiteData.submit_endpoint = window.localStorage.getItem('submit_endpoint'); // "https://local.wordpress.test/wp-json\/pf/v1/submit-nomination";
...
window.pfSiteData.categories_endpoint = window.localStorage.getItem('categories_endpoint'); // 'https://local.wordpress.test/wp-json/wp/v2/categories';
